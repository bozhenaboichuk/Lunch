...
def populate_dish_types
  ...
  DishType.create [{name: I18n.t('db.seeds.first_dish'), heading: I18n.t('db.seeds.first_dish')},
                   {name: I18n.t('db.seeds.second_dish'), heading: I18n.t('db.seeds.second_dish')},
                   {name: I18n.t('db.seeds.salad_dish'), heading: I18n.t('db.seeds.salad_dish')},
                   {name: I18n.t('db.seeds.desert_dish'), heading: I18n.t('db.seeds.desert_dish')},
                   {name: I18n.t('db.seeds.pizza_dish'), heading: I18n.t('db.seeds.pizza_dish')},
                   {name: I18n.t('db.seeds.sushi_dish'), heading: I18n.t('db.seeds.sushi_dish')},
                   {name: I18n.t('db.seeds.drinks_dish'), heading: I18n.t('db.seeds.drinks_dish')},
                   {name: I18n.t('db.seeds.other_dishes'), heading: I18n.t('db.seeds.other_dishes')},
                   {name: I18n.t('db.seeds.sets_dish'), heading: I18n.t('db.seeds.sets_dish')}]
end
...
def populate_restaurants
  ...
  Restaurant.create [{ name: "Пронто Піца",
                       ...
                       picture: open(img_path "logo-pronto5f4dff025bafc.png") },
                     { name: "Десятка",
                       address: "вулиця Шашкевича, 4",
                       phone_number: "+380503738202",
                       picture: open(img_path "logodesiatka.png") }]
end
...
def populate_dishes
  ...
  Dish.create [{ name: "4 сезони",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.pizza_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "4-sezony-350x350.png"),
                 weight:0.5,
                 price:154,
               ...
               { name: "4 сири",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.pizza_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "4-syry-4.png"),
                 weight:0.42,
                 price:169,
               ...
               { name: "Козацька",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.pizza_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "kozaczka.png"),
                 weight:0.545,
                 price:159,
               ...
               { name: "Корнелія",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.pizza_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "salyamikukurudza-kopiya.png"),
                 weight:0.45,
                 price:134,
               ...
               { name: "Маргарита",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.pizza_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "margaryta-1.png"),
                 weight:0.45,
                 price:108,
               ...
               { name: "Мексиканська",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.pizza_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "meksykanska-2.png"),
                 weight:0.51,
                 price:174,
               ...
               { name: "Папероні",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.pizza_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "paperoni.png"),
                 weight:0.41,
                 price:157,
               ...
               { name: "Песто",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.pizza_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "pesto.png"),
                 weight:0.46,
                 price:164,
               ...
               { name: "Піца з грушею",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.pizza_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "z-grusheyu-2.png"),
                 weight:0.46,
                 price:167,
               ...
               { name: "Пронто",
                 ...
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.pizza_dish')),
                 restaurant: pronto_pizza,picture: open(img_path "pronto.png"),
                 weight:0.6,
                 price:175,
               ...
               { name: "Прошуто Фунгі",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.pizza_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "proshuto-fungi.png"),
                 weight:0.43,
                 price:139,
               ...
               { name: "Сальмоне",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.pizza_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "salmone-2-350x350.png"),
                 weight:0.42,
                 price:175,
               ...
               { name: "Салямі",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.pizza_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "salyami-1-350x350.png"),
                 weight:0.4,
                 price:139,
               ...
               { name: "Супрім",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.pizza_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "suprim-2-350x350.png"),
                 weight:0.46,
                 price:139,
               ...
               { name: "Техас",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.pizza_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "tehaska-350x350.png"),
                 weight:0.49,
                 price:158,
               ...
               { name: "Фелічіта",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.pizza_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "felichita-350x350.png"),
                 weight:0.53,
                 price:153,
               ...
               { name: "Цезар",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.pizza_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "czezar-350x350.png"),
                 weight:0.575,
                 price:169,
               ...
               { name: "Чізбургер",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.pizza_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "chizburger-350x350.png"),
                 weight:0.54,
                 price:144,
               ...
               { name: "Місо суп з креветками",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.first_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "misozkrevet.png"),
                 weight:0.35,
                 price:99,
               ...
               { name: "Місо суп з лососем",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.first_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "misozlososem.png"),
                 weight:0.35,
                 price:99,
               ...
               { name: "Том ям з креветками",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.first_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "tomjam-z-krev.png"),
                 weight:0.35,
                 price:99,
               ...
               { name: "Том ям з лососем",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.first_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "tomjam-z-lososem.png"),
                 weight:0.35,
                 price:99,
               ...
               { name: "Бульйон з куркою",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.first_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "bul-275x275.png"),
                 weight:0.361,
                 price:47,
                 describe:"Курячий бульйон на основі домашньої курятини та овочів, з локшиною та зеленню"},

               { name: "Картопля Фрі",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.other_dishes')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "1kartoplya-fri.jpg"),
                 weight:0.1,
                 price:38,
               ...
               { name: "Курячі крильця",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.other_dishes')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "1kuryachi-krylczya.jpg"),
                 weight:0.35,
                 price:84,
               ...
               { name: "Курячі нагетси",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.other_dishes')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "1kuryachi-nagetsy.jpg"),
                 weight:0.19,
                 price:57,
               ...
               { name: "Соус Барбекю",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.other_dishes')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "1barbekyu-275x275.jpg"),
                 weight:0.05,
                 price:14,
               ...
               { name: "Соус Цезар",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.other_dishes')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "1czezar-275x275.jpg"),
                 weight:0.05,
                 price:14,
                 describe:"Фірмовий соус за власним рецептом"},
               { name: "Соус Часниковий",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.other_dishes')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "1chasnykovyj-275x275.jpg"),
                 weight:0.05,
                 price:14,
                 describe:"Фірмовий соус за власним рецептом"},
               ...
               { name: "Салат Грецький",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.salad_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "1sgreczkyj-275x275.png"),
                 weight:0.21,
                 price:69,
               ...
               { name: "Салат з Лососем",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.salad_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "1sz-lososem-275x275.png"),
                 weight:0.19,
                 price:97,
               ...
               { name: "Салат Фітнес",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.salad_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "1sfitnes-275x275.png"),
                 weight:0.19,
                 price:69,
               ...
               { name: "Салат Цезар",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.salad_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "1sczezar-1-275x275.png"),
                 weight:0.23,
                 price:79,
               ...
               { name: "Салат Чука",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.salad_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "1ssalat-chuka-275x275.png"),
                 weight:0.19,
                 price:67,
                 describe:"Салат чука, горіховий соус, кунжут"},
               { name: "Садочок в асортименті 1л",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.drinks_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "1nsadochok.jpg"),
                 weight:1,
                 price:37},
               { name: "Сандора томатна 1л",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.drinks_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "1nsandora-tomat.jpg"),
                 weight:1,price:48},
               { name: "Сандора Фруктова 1л",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.drinks_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "1nsandora-fr.jpg"),
                 weight:1,
                 price:48},
               { name: "7UP",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.drinks_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "1n7up.png"),
                 weight:1,
                 price:28},
               { name: "Mirinda",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.drinks_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "1nmirinda.png"),
                 weight:1,
                 price:28},
               { name: "Пепсi ж/б",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.drinks_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "1npepsi-zh.jpg"),
                 weight:0.33,
                 price:18},
               { name: "Пепсi",
                 dish_type: DishType.find_by(name: I18n.t('db.seeds.drinks_dish')),
                 restaurant: pronto_pizza,
                 picture: open(img_path "1npepsi.jpg"),
                 weight:2,
                 price:44}
               ]
end
